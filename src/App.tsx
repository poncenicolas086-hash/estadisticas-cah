...
import WidgetCalendario from './data/widgetcalendario';
    ...
    <div className="home-container">
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', 'Segoe UI', sans-serif; }
        ...
        .rival-titulo { font-size: 1.25rem; font-weight: 800; text-transform: uppercase; margin-bottom: 20px; color: #ff0404; text-align: center; width: 100%; max-width: 700px; padding: 0 15px; line-height: 1.3; }
